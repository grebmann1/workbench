...
- **Scaffolding skill:** `.Codex/skills/new-workbench-app/SKILL.md` — invoke when asked to create/scaffold a new app; it collects the required manifest fields, wires tsconfig, and runs the generator.
