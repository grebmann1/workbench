...
1. Fill in the manifest using the collected answers. A skeleton with placeholders lives at `.Codex/skills/new-workbench-app/manifest-template.json` — use it when copying urlencoder isn't convenient.
