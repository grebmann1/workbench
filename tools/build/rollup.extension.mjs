...
const getSharedModulePath = (moduleName) => {
    ...
    const distPath = r(`../../packages/lwc/shared/dist/modules/${moduleName}/${entryFile}.js`);
    if (fs.existsSync(distPath)) {
        return distPath;
    }
    return r(`../../packages/lwc/shared/modules/${moduleName}/${entryFile}.ts`);
};
...
const coreAliasEntries = [
    { find: 'core/bash', replacement: r('../../packages/lwc/main/core/bash/bash.ts') },
    { find: 'core/fs', replacement: r('../../packages/lwc/main/core/fs/fs.ts') },
];
...
const vscodePureAliasEntries = [
    { find: 'vscode/metadataApi', replacement: r('../../packages/lwc/shared/modules/metadataApi/metadataApi.ts') },
    { find: 'vscode/toolingApi', replacement: r('../../packages/lwc/shared/modules/toolingApi/toolingApi.ts') },
    { find: 'vscode/sourceTracking', replacement: r('../../packages/lwc/shared/modules/sourceTracking/sourceTracking.ts') },
    // workbench modules (consumed by fullApp.ts via module aliases)
    // bridge aliases (consumed transitively by workbench modules)
    { find: 'vscode/bridge/iframeFsBridgeContract', replacement: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeFsBridgeContract.ts') },
    { find: 'vscode/bridge/iframeFsBridgeClient', replacement: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeFsBridgeClient.ts') },
    { find: 'vscode/bridge/bootstrapIframeBridge', replacement: r('../../packages/lwc/main/vscode/fullApp/bridge/bootstrapIframeBridge.ts') },
    { find: 'vscode/bridge/iframeJsforceBridgeContract', replacement: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeJsforceBridgeContract.ts') },
    { find: 'vscode/bridge/bootstrapIframeJsforceBridge', replacement: r('../../packages/lwc/main/vscode/fullApp/bridge/bootstrapIframeJsforceBridge.ts') },
...
const modules = [
    ...
    { name: 'core/bash', path: r('../../packages/lwc/main/core/bash/bash.ts') },
    ...
    { name: 'host-api/connector', path: r('../../packages/lwc/main/host-api/connector.ts') },
    { name: 'host-api/utils', path: r('../../packages/lwc/main/host-api/utils.ts') },
    ...
    { name: 'api/slices/apiHeaderPresets', path: r('../../packages/lwc/applications/api/slices/apiHeaderPresets.ts') },
    { name: 'api/slices/apiAuthProfiles', path: r('../../packages/lwc/applications/api/slices/apiAuthProfiles.ts') },
    { name: 'api/slices/apiChains', path: r('../../packages/lwc/applications/api/slices/apiChains.ts') },
    ...sharedModules,
    ...
    { name: 'vscode/metadataApi', path: r('../../packages/lwc/shared/modules/metadataApi/metadataApi.ts') },
    { name: 'vscode/toolingApi', path: r('../../packages/lwc/shared/modules/toolingApi/toolingApi.ts') },
    { name: 'vscode/sourceTracking', path: r('../../packages/lwc/shared/modules/sourceTracking/sourceTracking.ts') },
    ...
    { name: 'vscode/bridge/iframeFsBridgeContract', path: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeFsBridgeContract.ts') },
    { name: 'vscode/bridge/iframeFsBridgeClient', path: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeFsBridgeClient.ts') },
    { name: 'vscode/bridge/bootstrapIframeBridge', path: r('../../packages/lwc/main/vscode/fullApp/bridge/bootstrapIframeBridge.ts') },
    { name: 'vscode/bridge/iframeJsforceBridgeContract', path: r('../../packages/lwc/main/vscode/fullApp/bridge/iframeJsforceBridgeContract.ts') },
    { name: 'vscode/bridge/bootstrapIframeJsforceBridge', path: r('../../packages/lwc/main/vscode/fullApp/bridge/bootstrapIframeJsforceBridge.ts') },
...
const coreStoreToLightStoreAlias = alias({
    entries: [
        {
            find: 'core/store',
            replacement: r('../../packages/lwc/main/core/store/lightStore.ts'),
        },
    ],
});
