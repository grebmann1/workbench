...
const modules = [
    ...
    { name: 'host-api/announce', path: r('../../packages/lwc/main/host-api/announce/announce.ts') },
    { name: 'host-api/shortcuts', path: r('../../packages/lwc/main/host-api/shortcuts/shortcuts.ts') },
