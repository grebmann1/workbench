...
const modules = [
    ...
    { name: 'host-api/store', path: r('../../packages/lwc/app/host-api/store.ts') },
    { name: 'host-api/types', path: r('../../packages/lwc/app/host-api/types.ts') },
    { name: 'host-api/element', path: r('../../packages/lwc/app/host-api/element.ts') },
    { name: 'host-api/connector', path: r('../../packages/lwc/app/host-api/connector.ts') },
    { name: 'host-api/utils', path: r('../../packages/lwc/app/host-api/utils.ts') },
    { name: 'host-api/logger', path: r('../../packages/lwc/app/host-api/logger.ts') },
    { name: 'host-api/analytics', path: r('../../packages/lwc/app/host-api/analytics.ts') },
    { name: 'host-api/builder', path: r('../../packages/lwc/app/host-api/builder.ts') },
    { name: 'host-api/commands', path: r('../../packages/lwc/app/host-api/commands.ts') },
    { name: 'host-api/desktopBridge', path: r('../../packages/lwc/app/host-api/desktopBridge.ts') },
    { name: 'host-api/fs', path: r('../../packages/lwc/app/host-api/fs.ts') },
    { name: 'host-api/worker', path: r('../../packages/lwc/app/host-api/worker.ts') },
    { name: 'soql/slices', path: r('../../packages/applications/soql/slices/slices.ts') },
    { name: 'soql/slices/ui', path: r('../../packages/applications/soql/slices/ui.ts') },
    { name: 'soql/slices/query', path: r('../../packages/applications/soql/slices/query.ts') },
    { name: 'metadata/slices', path: r('../../packages/applications/metadata/slices/slices.ts') },
    { name: 'metadata/slices/metadata', path: r('../../packages/applications/metadata/slices/metadata.ts') },
    { name: 'object/slices', path: r('../../packages/applications/object/slices/slices.ts') },
    { name: 'object/slices/sobjectExplorer', path: r('../../packages/applications/object/slices/sobjectExplorer.ts') },
    { name: 'package/slices', path: r('../../packages/applications/package/slices/slices.ts') },
    { name: 'package/slices/package', path: r('../../packages/applications/package/slices/package.ts') },
    { name: 'platformevent/slices', path: r('../../packages/applications/platformevent/slices/slices.ts') },
    { name: 'platformevent/slices/platformEvent', path: r('../../packages/applications/platformevent/slices/platformEvent.ts') },
    { name: 'recordviewer/slices', path: r('../../packages/applications/recordviewer/slices/slices.ts') },
    { name: 'recordviewer/slices/recordViewer', path: r('../../packages/applications/recordviewer/slices/recordViewer.ts') },
    { name: 'anonymousApex/slices', path: r('../../packages/applications/anonymousApex/slices/slices.ts') },
    { name: 'anonymousApex/slices/apex', path: r('../../packages/applications/anonymousApex/slices/apex.ts') },
    { name: 'api/slices', path: r('../../packages/applications/api/slices/slices.ts') },
    { name: 'api/slices/api', path: r('../../packages/applications/api/slices/api.ts') },
    ...sharedModules,
