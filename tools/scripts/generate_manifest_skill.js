...
function buildManifest(skillsRoot) {
    const skillPaths = collectSkillPaths(skillsRoot, skillsRoot);
    return {
        _comment:
            'Auto-generated by tools/scripts/generate_manifest_skill.js — do not edit. Run: npm run generate:skills-manifest',
        skills: skillPaths,
    };
}

function generateManifest() {
    const manifest = buildManifest(ALL_SKILLS_ROOT);
    fs.writeFileSync(MANIFEST_FILE, JSON.stringify(manifest, null, 2) + '\n', 'utf8');
    console.log('Generated', MANIFEST_FILE, 'with', manifest.skills.length, 'skill paths.');
}
...
module.exports = { collectSkillPaths, buildManifest };
