...
let _anonymousApexBootstrapped = false;
function bootstrapAnonymousApexExtension() {
    if (_anonymousApexBootstrapped) return;
...
export default class App extends ToolkitElement {
    ...
    recentApexItems: AnyRecord[] = [];
    savedApexItems: AnyRecord[] = [];
    ...
    // Current
    apexScript: string | null = null; // ='CCR_TaskNotification__e event = new CCR_TaskNotification__e();\n// Publish the event\nDatabase.SaveResult result = EventBus.publish(event);';
    ...
    // Changes
    currentFile: AnyRecord | null = null;
    isDraft = false;
