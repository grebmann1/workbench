...
export function buildTruncatedText(text, savedPath, notice, options = {}) {
    ...
    const maxHeadLength = (headHeaderLength) => Math.max(0, maxToolOutputChars -
        tail.length -
        notice.length -
...
//# sourceMappingURL=toolOutputTruncation.js.map