...
export { formatBytes, basicTextFormatter, shortFormatter, detectLanguageFromContentType, autoDetectAndFormat, } from './format';
// DOM utilities
...
// String utilities
export { escapeRegExp, checkIfPresent, isSalesforceId, capitalizeFirstLetter, compareString, isSame, lowerCaseKey, splitTextByTimestamp, stripNamespace, } from './string';
// Chrome extension utilities
export { getAllOrgs, hasVscodeAliasBootstrap, hasVscodeBootstrapEntrySeed, hasVscodeExplicitBootstrap, hasVscodeSessionBootstrap, normalizeVscodeBootstrapSeed, parseVscodeBootstrapSeed, getVscodeEditorUrl, redirectToUrlViaChrome, getCurrentTab, refreshCurrentTab, } from './chrome';
...
export { getObjectSetupLink, getCustomMetadataLink, getObjectFieldsSetupLink, getObjectFieldDetailSetupLink, getObjectListLink, getRecordTypesLink, getObjectDocLink, } from './salesforceLinks';
// Miscellaneous utilities
export { decodeError, download, ROLES, forceVariableSave, generateExternalId, isObject, getFieldValue, extractErrorDetailsFromQuery, isMonacoLanguageSetup, prettifyXml, } from './misc';
