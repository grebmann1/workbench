...
type MarkedOptions = Record<string, unknown> & {
    highlight?: (code: string, lang: string | undefined, callback?: (err?: Error) => void) => void;
    renderer?: unknown;
    sanitize?: boolean;
...
export const marked = function (root: unknown) {
    ...
    function marked(src: string, opt?: MarkedOptions | null, callback?: MarkedCallback) {
