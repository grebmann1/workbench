 ...
 * @returns {string}
 */
export function fullApiName(name: string | null | undefined, namespace?: string | null): string {
    if (name == null) return '';
    const n = String(name);
...
export function getSobject(href: string): string | null {
...
const extractRecordId = (href?: string | null): string | null => {
    if (!href) return null;
    try {
        const url = new URL(href);
...
export function getRecordId(href: string): string | null {
...
export function getCurrentObjectType(
    conn: ToolingConnection,
    recordId: string
): Promise<string | null> {
