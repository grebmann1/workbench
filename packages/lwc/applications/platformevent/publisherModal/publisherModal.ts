...
export default class PublisherModal extends LightningModal {
    ...
    @api apiName: string | null = null;
    @api instanceUrl: string | null = null;
    @api accessToken: string | null = null;
    @api apiVersion: string | null = null;
    ...
    toApexLiteral(value: any): string {
    ...
    copyApexSnippet = async (): Promise<void> => {
        try {
