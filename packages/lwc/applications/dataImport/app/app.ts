...
export default class App extends ToolkitElement {
    ...
    // CSV
    @track csvFileName: string | null = null;
    @track csvError: string | null = null;
    csvText: string | null = null;
    csvHeaders: string[] = [];
    csvRows: Array<Record<string, any>> = []; // array of objects keyed by header

    // SObject describe
    sobjectDescribe: AnyRecord | null = null;
    @track objectError: string | null = null;
    @track sobjectOptions: Array<{ label: string; value: string }> = [];
    @track fieldNames: string[] = [];
    @track externalIdOptions: Array<{ label: string; value: string }> = [];

    // Mapping
    @track mappingRows: AnyRecord[] = []; // { key, csvHeader, targetField, error, inputId, inputClass }
    ...
    results: AnyRecord[] = []; // row-level results, normalized
    lastRestPayload: Array<{ rowIndex: number; record: AnyRecord }> | null = null;

    // Jobs
    @track jobs: AnyRecord[] = [];
    @track jobsError: string | null = null;
    isJobsRefreshing = false;
    @track selectedJob: AnyRecord | null = null;
    @track selectedJobDetails: AnyRecord | null = null;
    ...
    @track failedPreviewColumns: string[] = [];
    @track failedPreviewRows: AnyRecord[] = [];
    ...
    failedPreviewEditorModel: any = null;
