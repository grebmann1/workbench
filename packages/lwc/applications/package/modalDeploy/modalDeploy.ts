...
export default class ModalDeploy extends LightningModal {
    ...
    isRunning = false;
    file: File | null = null;
    zip64: string | null = null;

    // Models
    responseModel: any = null;
    deploymentPromise: any = null;
    ...
    // Options
    testLevel_value: string = TESTLEVEL.NoTestRun;

    @wire(connectStore, { store })
    storeChange({ package2, application }: { package2: any; application: any }) {
        // Deployment
    ...
    verifyIsActive = (applicationName: string): boolean => {
