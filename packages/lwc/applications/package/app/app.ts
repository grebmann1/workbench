...
let _packageBootstrapped = false;
function bootstrapPackageExtension() {
    if (_packageBootstrapped) return;
    _packageBootstrapped = true;
    injectReducer('package2', PACKAGE.reduxSlice.reducer);
}
