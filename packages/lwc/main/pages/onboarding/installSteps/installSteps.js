...
export default class installSteps extends LightningElement {
    ...
    @track steps = [
        {
            ...
            description:
                'For the best experience, pin the Workbench extension to your browser toolbar. </br> Click the puzzle icon (Extensions), then click the pin next to Workbench. Once pinned, click the extension icon to open it and view your credentials instantly.',
        ...
        },
        {
            ...
            description:
                'To get started, open the Workbench by clicking the extension icon in your browser toolbar. You can also use the keyboard shortcut shown below. Watch the animation for a quick demonstration.',
        ...
        },
        {
            ...
            description:
                'With Workbench, you can easily query and export your Salesforce data in just a few clicks. Use the built-in SOQL editor to run queries and export results to CSV. </br> You can even set up a custom shortcut for quick access to the query tool directly from the settings!',
    ...
    handleOpenMediaFullscreen() {
        this.isMediaFullscreen = true;
    }

    handleCloseMediaFullscreen() {
        this.isMediaFullscreen = false;
    }

    handleMediaLightboxClick(event) {
        if (event.target?.dataset?.role === 'backdrop') {
            this.handleCloseMediaFullscreen();
        }
    }
    ...
    get formattedSteps() {
        return this.steps.map((step, index) => ({
            ...
            ariaCurrent: this.currentStepIndex === index ? 'step' : 'false',
        }));
    }
}
