// Files seeded into the in-browser workspace on first load. The embedded
// VSCode iframe has its own equivalent template for its own purposes; the host
// workbench keeps a minimal, self-contained copy so it stays decoupled from
// `vscode/workbench/*`.
