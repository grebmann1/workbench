...
export default class ConnectionDetailModal extends LightningModal {
    @api company: string | undefined;
    @api orgId: string | undefined;
    @api name: string | undefined;
    @api alias: string | undefined;
    @api username: string | undefined;
    @api instanceUrl: string | undefined;
    @api sfdxAuthUrl: string | undefined;
    @api frontDoorUrl: string | undefined;
    @api accessToken: string | undefined;
    @api credentialType: string | undefined;
    @api password: string | undefined;
    @api redirectUrl: string | undefined;
    @api connections: any[] = [];
    @api mode = 'view'; // 'view' or 'edit'

    @track showAccessToken = false;
    @track showPassword = false;
    @track selectedCategory: Array<{ id: string; icon: string; title: string }> = [];
    @track isNewCategoryDisplayed = false;
    @track newCategory: string | undefined;
    @track errors: Array<{ message: string }> = [];
    @track orgName: string | undefined;
    @track newAlias: string | undefined;
