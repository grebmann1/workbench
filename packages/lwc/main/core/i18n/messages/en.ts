const messages = {
    ...
    OUTPUT_PANEL_FAILED_EXPORT_JSON: 'Failed to export JSON',
    OUTPUT_PANEL_FAILED_EXPORT_EXCEL: 'Failed to export EXCEL',
    ...
    API_LIST_PANEL_RECENT: 'Recent API',
    API_LIST_PANEL_SAVED: 'Saved API',
