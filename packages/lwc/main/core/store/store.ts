...
// `Record<string, Reducer>` would collapse the state type to `unknown` and
// break every typed selector downstream.
const staticReducers = {
    ...
    backgroundJobs: BACKGROUNDJOB.reduxSlice.reducer,
