...
- **Preview / staging app**: duplicate the provisioning section under `workbench2-staging` with different domains (e.g. `staging.sf-workbench.com`) before shipping risky changes.
